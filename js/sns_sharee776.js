var SNS = function(){
	...
	var getDefaultHtml = function(){
		...
		html += "</ul>";
		html += "</div>";
		html += "<div class='url-copy'>";

		html += "<input type='text' class='_sns_copy_url form-control' value='" + link_url + "'>";
		html += "<div class='form-control-line'></div>";
		html += "</div>";
		//html += "<div class='input-group-btn'>";
		//html += "<button type='button' class='_sns_copy_btn btn btn-default' onclick=\"SNS.copyToClipboard()\" data-clipboard-target='._sns_copy_url'>URL 복사</button>";
		//html += "</div>";
